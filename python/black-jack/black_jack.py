...
def is_blackjack(card_one, card_two):
    ...
    if card_one not in ten_set and card_two not in ten_set:
        return False
...
def can_split_pairs(card_one, card_two):
    ...
    return card_one == card_two or (card_one in ten_set and card_two in ten_set)
...
def can_double_down(card_one, card_two):
    ...
    return 8 <= value_of_card(card_one) + value_of_card(card_two) <= 11
